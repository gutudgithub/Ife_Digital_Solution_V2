...
| 7 | Public business profile, QR storefront, and verification | Proposed next stage; feature brief requires product-owner approval |
...
The proposed Stage 7 is a public read-only business identity and catalog-browsing stage. It
does not add customer accounts, ordering, checkout, payment, delivery, loyalty, promotions,
public reviews, or public access to operational records.
